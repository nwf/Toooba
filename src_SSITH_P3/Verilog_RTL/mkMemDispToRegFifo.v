...
//
// On Sat Jul 18 16:21:00 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkMemDispToRegFifo(CLK,
  ...
  wire [11 : 0] sb__h4535, upd__h1154;
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h4535 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN = enq_x[145:12] ;
  assign m_m_row_0$EN = EN_enq ;

  // register m_m_specBits_0_rl
  assign m_m_specBits_0_rl$D_IN =
	     EN_specUpdate_correctSpeculation ? upd__h1154 : sb__h4535 ;
  ...
  // remaining internal signals
  assign sb__h4535 = EN_enq ? enq_x[11:0] : m_m_specBits_0_rl ;
  ...
  initial
  begin
    m_m_row_0 = 134'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
