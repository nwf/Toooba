...
//
// On Sat Jul 18 16:23:23 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkGSelectPred(CLK,
  ...
  wire [7 : 0] gHist__h1963, gHist__h2309;
  ...
  // actionvalue method pred_1_pred
  assign pred_1_pred = { tab$D_OUT_1[1], gHist__h2309 } ;
  ...
  // submodule tab
  assign tab$ADDR_1 = { gHist__h2309, pred_1_pred_pc[5:2] } ;
  ...
  assign IF_predCnt_lat_0_whas_THEN_predCnt_lat_0_wget__ETC___d8 =
	     EN_pred_0_pred ? upd__h2389 : predCnt_rl ;
  assign IF_predRes_lat_0_whas__5_THEN_predRes_lat_0_wg_ETC___d18 =
	     EN_pred_0_pred ? upd__h2605 : predRes_rl ;
  ...
  assign upd__h2389 = predCnt_rl + 2'd1 ;
  assign upd__h2605 =
	     tab$D_OUT_2[1] ? predRes_rl | x__h2076 : predRes_rl & y__h2277 ;
  assign x__h2076 = 2'd1 << predCnt_rl ;
  assign x__h2450 =
	     2'd1 << IF_predCnt_lat_0_whas_THEN_predCnt_lat_0_wget__ETC___d8 ;
  assign y__h2277 = ~x__h2076 ;
  assign y__h2638 = ~x__h2450 ;
