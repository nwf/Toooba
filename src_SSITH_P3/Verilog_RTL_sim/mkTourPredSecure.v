...
//
// On Sat Jul 18 16:10:15 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkTourPredSecure(CLK,
  ...
  begin
    case (globalHist__h7945[7:0])
      ...
      default: cnt__h8084 = 2'bxx /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (globalHist__h7945[7:0])
      ...
      default: cnt__h8776 = 2'bxx /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (globalHist__h9255[7:0])
      ...
      default: cnt__h9422 = 2'bxx /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (globalHist__h9255[7:0])
      ...
      default: cnt__h10110 = 2'bxx /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (updateEn$wget[20:13])
      ...
      default: globalCnt__h3336 = 2'bxx /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (updateEn$wget[20:13])
      ...
      default: choiceCnt__h4464 = 2'bxx /* unspecified value */ ;
    endcase
  end
