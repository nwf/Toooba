...
//
// On Sat Jul 18 15:59:31 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkJtagTap(CLK,
  ...
  reg [40 : 0] CASE_newir772_0_1_1_2147483648_0x10_2147483648_ETC__q1,
	       v__h2479;
  reg [4 : 0] newir__h3772;
  ...
  wire [39 : 0] IF_r_dmistat_busy_port0__read__42_OR_NOT_r_dmi_ETC___d145,
		value__h2711;
  wire [4 : 0] v__h3634, x__h3685, y__h3686;
  ...
  assign r_drmask$D_IN =
	     (r_state$Q_OUT == 4'd3) ?
	       CASE_newir772_0_1_1_2147483648_0x10_2147483648_ETC__q1 :
	       r_drmask ;
  ...
  assign r_state__read_EQ_8_8_AND_r_ir_3_EQ_0x11_1_AND__ETC___d78 =
	     ...
	     r_dmi$Q_OUT[1:0] != 2'd3 &&
	     !f_dmi_busy$EMPTY_N ;
  assign v__h2576 = { 36'd7864320, r_ir } ;
  ...
  assign x__h3685 = { 1'd0, r_ir[4:1] } ;
  assign y__h2997 = jtag_tdi ? r_drmask : 41'd0 ;
  assign y__h3686 = jtag_tdi ? 5'd16 : 5'd0 ;
  always@(r_state$Q_OUT or r_ir or v__h3634)
  begin
    case (r_state$Q_OUT)
      4'd0: newir__h3772 = 5'd1;
  ...
  begin
    case (r_ir)
      5'd0, 5'h12, 5'h13, 5'h14, 5'h15, 5'h16, 5'h17, 5'd31: v__h2479 = 41'd0;
      5'd1: v__h2479 = 41'd4093;
  ...
  begin
    case (newir__h3772)
	  ...
	  CASE_newir772_0_1_1_2147483648_0x10_2147483648_ETC__q1 = 41'd1;
      5'd1, 5'h10:
	  CASE_newir772_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
	      41'h00080000000;
      5'h11:
	  CASE_newir772_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
	      41'h10000000000;
      default: CASE_newir772_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
		   41'h00100000000;
    endcase
  end
