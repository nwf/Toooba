...
//
// On Sat Jul 18 16:08:51 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkBht(CLK,
  ...
  wire [1 : 0] next_hist__h586, next_hist__h592;
  ...
  assign hist$D_IN = update_taken ? next_hist__h586 : next_hist__h592 ;
  assign hist$WE = EN_update ;

  // remaining internal signals
  assign next_hist__h586 =
	     (hist$D_OUT_3 == 2'b11) ? hist$D_OUT_3 : hist$D_OUT_3 + 2'd1 ;
  assign next_hist__h592 =
