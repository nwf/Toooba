...
//
// On Sat Jul 18 16:13:20 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkJtagTap(CLK,
  ...
  reg [40 : 0] CASE_newir772_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1,
	       v__h2479;
  reg [17 : 0] newir__h3772;
  reg [3 : 0] CASE_r_stateQ_OUT_0_1_1_1_2_3_3_4_4_4_5_6_6_6_ETC__q3,
	      CASE_r_stateQ_OUT_0_r_stateQ_OUT_1_2_2_9_3_5_ETC__q2;
  wire [40 : 0] v__h2576, v__h2941, x__h2789, x__h2996, y__h2997;
  wire [39 : 0] IF_r_dmistat_busy_port0__read__42_OR_NOT_r_dmi_ETC___d145,
		value__h2711;
  wire [17 : 0] v__h3634, x__h3685, y__h3686;
  ...
  assign r_drmask$D_IN =
	     (r_state$Q_OUT == 4'd3) ?
	       CASE_newir772_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 :
	       r_drmask ;
  assign r_drmask$EN = 1'd1 ;

  // register r_ir
  assign r_ir$D_IN = newir__h3772 ;
  assign r_ir$EN = 1'd1 ;
  ...
  // remaining internal signals
  assign IF_r_dmistat_busy_port0__read__42_OR_NOT_r_dmi_ETC___d145 =
	     (r_dmistat_busy ||
  ...
  assign r_state__read_EQ_8_8_AND_r_ir_3_EQ_0b111001001_ETC___d78 =
	     ...
	     r_dmi$Q_OUT[1:0] != 2'd3 &&
	     !f_dmi_busy$EMPTY_N ;
  assign v__h2576 = { 23'd960, r_ir } ;
  assign v__h2941 = x__h2996 | y__h2997 ;
  assign v__h3634 = x__h3685 | y__h3686 ;
  assign value__h2711 =
	     { 6'bxxxxxx /* unspecified value */ ,
	       32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */ ,
	       2'd3 } ;
  assign x__h2789 = { 29'd0, r_dmi$Q_OUT[1:0], 10'd113 } ;
  assign x__h2996 = { 1'd0, r_dr[40:1] } ;
  assign x__h3685 = { 1'd0, r_ir[17:1] } ;
  assign y__h2997 = jtag_tdi ? r_drmask : 41'd0 ;
  assign y__h3686 = jtag_tdi ? 18'd131072 : 18'd0 ;
  always@(r_state$Q_OUT or r_ir or v__h3634)
  begin
    case (r_state$Q_OUT)
      4'd0: newir__h3772 = 18'd1;
      4'd3, 4'd4, 4'd8: newir__h3772 = r_ir;
      4'd11: newir__h3772 = v__h3634;
      default: newir__h3772 = r_ir;
    endcase
  end
  always@(r_ir or
	  v__h2576 or
	  IF_r_dmistat_busy_port0__read__42_OR_NOT_r_dmi_ETC___d145 or
	  x__h2789)
  begin
    case (r_ir)
      18'd0,
      ...
      18'd262143:
	  v__h2479 = 41'd0;
      18'd1: v__h2479 = 41'd4093;
      18'b000011100100100100:
	  v__h2479 =
	      { 1'd0,
		IF_r_dmistat_busy_port0__read__42_OR_NOT_r_dmi_ETC___d145 };
  ...
  begin
    case (newir__h3772)
      ...
      18'h00017,
      18'd262143:
	  CASE_newir772_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 = 41'd1;
	  ...
	  CASE_newir772_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 =
	      41'h10000000000;
      default: CASE_newir772_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 =
		   41'h00100000000;
    endcase
  end
  ...
  begin
    r_dmistat_busy = 1'h0;
    r_dr = 41'h0AAAAAAAAAA;
    r_drmask = 41'h0AAAAAAAAAA;
    r_ir = 18'h2AAAA;
    r_tdo = 1'h0;
  end
