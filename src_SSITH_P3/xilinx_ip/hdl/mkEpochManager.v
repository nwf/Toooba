...
//
// On Sat Jul 18 16:14:48 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkEpochManager(CLK,
  ...
  // inlined wires
  wire [4 : 0] updatePrevEn_0_lat_0$wget,
	       updatePrevEn_0_lat_1$wget,
	       updatePrevEn_1_lat_0$wget;
  ...
  wire IF_updatePrevEn_1_lat_0_whas__6_THEN_NOT_updat_ETC___d36;
  ...
  assign updatePrevEn_0_lat_1$wget =
  ...
  // register updatePrevEn_0_rl
  assign updatePrevEn_0_rl$D_IN = updatePrevEn_0_lat_1$wget ;
  assign updatePrevEn_0_rl$EN = 1'd1 ;

  // register updatePrevEn_1_rl
  assign updatePrevEn_1_rl$D_IN = updatePrevEn_0_lat_1$wget ;
  ...
  begin
	...
	updatePrevEn_0_rl <= `BSV_ASSIGNMENT_DELAY
	    { 1'd0, 4'bxxxx /* unspecified value */  };
	updatePrevEn_1_rl <= `BSV_ASSIGNMENT_DELAY
	    { 1'd0, 4'bxxxx /* unspecified value */  };
      end
    else
      begin
