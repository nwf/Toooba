...
//
// On Sat Jul 18 16:23:24 BST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkTourGHistReg(CLK,
  ...
  // register m_hist
  assign m_hist$D_IN = EN_redirect ? redirect_newHist : x__h276[11:0] ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        m_hist <= `BSV_ASSIGNMENT_DELAY 12'd0;
      end
    else
      begin
